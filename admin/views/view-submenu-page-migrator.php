<div class="dpsp-page-wrapper dpsp-page-settings wrap">
	...
	<div class="dpsp-tool-wrapper">
		...
		<h4 style="text-align: left; padding: 15px;"><span class="dashicons dashicons-testimonial" style="margin-right: 10px;"></span><?php echo __( "Images Pin descriptions and repin ID data", 'social-pug' ); ?></h4>
